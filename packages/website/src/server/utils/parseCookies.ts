...
export interface Cookies {
  ...
  readonly device?: ReduxStore['ui']['device'];
}
...
export const isDeviceMode = (value: string | null): value is ReduxStore['ui']['device'] => {
  const variants: ReduxStore['ui']['device'][] = ['desktop', 'mobile', 'tablet'];

  return variants.includes(value as ReduxStore['ui']['device']);
};
