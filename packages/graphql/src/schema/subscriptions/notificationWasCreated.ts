...
interface Payload {
  readonly notificationWasCreated: readonly NotificationType[];
}

const notificationWasCreated: GraphQLFieldConfig<unknown, Context, Args> = {
  ...
  subscribe: withFilter(
    ...
    (payload: Payload, args: Args) => {
      const notification = payload.notificationWasCreated;
...
export default notificationWasCreated;
